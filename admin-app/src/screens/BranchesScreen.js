...
const styles = StyleSheet.create({
  ...
  keyValue: { color: colors.primary, fontSize: 30, fontWeight: "900", letterSpacing: 4, marginTop: 4 },
  shareBtn: { flexDirection: "row", alignItems: "center", backgroundColor: colors.primary, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 16 },
  shareTxt: { color: "#fff", fontWeight: "800", fontSize: 13 },
